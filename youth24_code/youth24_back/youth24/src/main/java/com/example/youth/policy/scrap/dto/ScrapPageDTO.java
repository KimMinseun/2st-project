...
public class ScrapPageDTO {
	...
	private int blockCount = 1024; // 한 페이지에 보여줄 레코드 수
	...
	public ScrapPageDTO(int currentPage, int totalCount) {
	...
	public ScrapPageDTO(int currentPage, int totalCount, String searchKey, String searchWord) {
	...
	public ScrapPageDTO(int currentPage, int totalCount, String userId) {
		this(currentPage, totalCount);
		this.userId = userId;
	}
	
	public ScrapPageDTO(int currentPage, int totalCount, int userKeynum) {
		this(currentPage, totalCount);
