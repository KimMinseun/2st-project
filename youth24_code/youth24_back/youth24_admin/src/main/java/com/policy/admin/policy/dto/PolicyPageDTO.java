package com.policy.admin.policy.dto;
...
public class PolicyPageDTO {
	...
	public PolicyPageDTO() {

	}

	public PolicyPageDTO(int currentPage, int totalCount) {
	...
	public PolicyPageDTO(int currentPage, int totalCount, String searchKey, String searchWord) {
