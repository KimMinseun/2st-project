package com.policy.admin.security.config;
...
import com.policy.admin.security.jwt.JwtAuthenticationFilter;
import com.policy.admin.security.jwt.JwtAuthorizationFilter;
import com.policy.admin.security.service.CorsConfig;
...
public class SecurityConfig {
	...
	SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		.antMatchers("/", "/login", "/admin/signup/idCheck", "/admin/delete", "/admin/userList/**", "/**", "/userSearch/**","/admin/searchAdmin/{currentPage}", "/admin/searchUser/{currentPage}")
